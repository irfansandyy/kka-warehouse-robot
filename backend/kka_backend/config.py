...
DEFAULT_MOVING_RANGE = _int_range("DEFAULT_MOVING_RANGE", (3, 10))
DEFAULT_ROBOT_RANGE = _int_range("DEFAULT_ROBOT_RANGE", (2, 5))
FORKLIFT_PATH_MIN = _int("FORKLIFT_PATH_MIN", 20)
